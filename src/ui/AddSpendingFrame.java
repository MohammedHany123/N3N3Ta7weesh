...
public class AddSpendingFrame extends JFrame {
    public AddSpendingFrame(User user, FileUserRepository repository) {
        ...
        formPanel.add(new JLabel("Spending Amount:"));
        ...
        saveBtn.addActionListener(e -> {
            try {
                ...
                user.getSpendingRecords().add(new SpendingRecord(category, amount));
                repository.saveUsers();
                JOptionPane.showMessageDialog(this, "Spending saved!");
                dispose();
            } catch (Exception ex) {
